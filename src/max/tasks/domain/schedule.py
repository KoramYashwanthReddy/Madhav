...
class TaskRecurrence(BaseModel):
    ...
    cron_expression: str | None = Field(
        default=None, description="Optional custom cron expression for CUSTOM type"
    )
...
class TaskSchedule(BaseModel):
    ...
    recurrence: TaskRecurrence | None = Field(
        default=None, description="Optional recurrence specification"
    )
