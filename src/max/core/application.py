"""Application factory for MAX platform foundation."""
...
from max.core.lifecycle import lifespan
from max.core.logging import setup_logging
...
def create_app(settings: Settings | None = None) -> FastAPI:
    ...
    app = FastAPI(
        ...
        description="MAX Personal AI System",
        docs_url=docs_url,
        redoc_url=redoc_url,
