...
from max.identity.schemas.assistant import AssistantIdentityUpdate
from max.identity.schemas.owner import OwnerIdentityUpdate, SafeIdentitySummary
from max.identity.schemas.preferences import (
    CommunicationPreferencesUpdate,
    LocalePreferencesUpdate,
    UserPreferencesUpdate,
)
from max.identity.schemas.profile import PersonalProfileUpdate, ProfileCompletenessResponse

logger = logging.getLogger("max.identity.service")
